...
class AzanPlaybackService : Service() {
    ...
    private fun startPlayback(prayerName: String, uriText: String) {
        stopPlayback(stopService = false)
        createChannel()
        startForeground(NOTIFICATION_ID, playbackNotification(prayerName))
    ...
    private fun playbackNotification(prayerName: String): android.app.Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText("Audio azan sedang dimainkan")
